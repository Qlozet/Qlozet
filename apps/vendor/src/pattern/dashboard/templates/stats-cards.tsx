            ...
            <div className="flex items-start justify-start gap-x-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="w-full flex items-center justify-between">
                  ...
                  <If isTrue={Boolean(stat.change)}>
                    <p
                      ...
                      className={cn(
                        ...
                        stat.change && changeToneClass(stat.change, stat.higherIsBetter)
                      )}
                    >
                  ...
                  <If isTrue={stat.id === 1} >
                    <Link href={APP_ROUTES.orders} className="ml-auto flex items-center text-success dark:text-gray-400 text-xs whitespace-nowrap">
                      <span>
                        View All
                      </span>
                      <span>
