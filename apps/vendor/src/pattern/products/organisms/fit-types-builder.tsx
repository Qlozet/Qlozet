  ...
  return (
    <div className={cardClass}>
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Define ease allowances for different fits (e.g. Regular, Relaxed).
        Values are added to body measurements in {unit}.
      </p>
      ...
      {bodyParts.length > 0 && (
        <div className="space-y-3">
          {fields.map((row, index) => {
            ...
            const watchedLabel =
              form.watch(`fit_types.${index}.label`) || `Fit Type ${index + 1}`;
