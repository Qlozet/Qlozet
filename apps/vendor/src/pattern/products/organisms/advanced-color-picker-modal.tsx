...
const AdvancedColorPickerModal = create<{ initialColor?: string }>(
  ({ initialColor = '#A855F7' }) => {
            ...
            <div className="p-6 pt-4 pb-4">
              ...
              <div className="mt-6 flex items-center gap-4">
                <div
                  ...
                  style={{
                    backgroundColor: getColorWithOpacity(color.hex, opacity),
                  }}
                />
                <div className="flex-1 space-y-2">
                  ...
                  <div className="text-xs text-muted-foreground">
                    HEX: {color.hex} | RGB: {color.rgb.r}, {color.rgb.g},{' '}
                    {color.rgb.b}
                  </div>
                </div>
              </div>
