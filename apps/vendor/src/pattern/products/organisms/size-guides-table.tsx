...
import { SizeGuide } from '@/redux/services/size-guides/size-guides.api-slice'
...
export const SizeGuidesTable = ({
    ...
    return (
        <>
                                    ...
                                    <div className='flex flex-col items-center gap-4'>
                                        ...
                                        <div className='flex flex-col items-center gap-2'>
                                            ...
                                            <p className='text-sm text-muted-foreground'>
                                                Create your first size guide to help customers find their perfect fit.
                                            </p>
                                        </div>
                                    </div>
                                </TableCell>
            ...
            {/* Pagination */}
            {!showLoader && isSuccess && table.getRowModel().rows?.length > 0 && (
                <div className='py-4'>
