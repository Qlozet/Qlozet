...
export interface ProductPreviewCardProps {
  ...
  conditionState: ReturnType<
    typeof import('../hooks/use-product-conditions').useProductConditions
  >;
              ...
              {availableForInclude.length === 0 ? (
                ...
                availableForInclude.slice(0, 20).map((product: any) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-grey-black dark:text-gray-200 truncate flex-1">
