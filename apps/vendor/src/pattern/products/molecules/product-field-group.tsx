...
const ProductFieldGroupRoot: React.FC<ProductFieldGroupProps> = ({
  children,
  className,
}) => {
...
const ProductFieldGroupLabel: React.FC<ProductFieldGroupLabelProps> = ({
  children,
  className,
  tooltip,
}) => {
...
const ProductFieldGroupContent: React.FC<ProductFieldGroupContentProps> = ({
  children,
}) => {
  return <div>{children}</div>;
};

const ProductFieldGroupFooter: React.FC<ProductFieldGroupFooterProps> = ({
  children,
}) => {
