...
import {
  PREDEFINED_COLORS,
  PredefinedColor,
} from '../constants/predefined-colors';
              ...
              {PREDEFINED_COLORS?.map((color) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1 w-fit px-2 py-1.5 hover:bg-gray-50 rounded-[6px] cursor-pointer transition-colors text-left ${
                      isSelected ? 'bg-blue-50' : 'bg-[#f1f1f1]'
                    }`}
                  >
                    <div
                      className={`w-5 h-5 rounded-[6px] border border-[#00000033] flex-shrink-0 ${
                        isSelected
