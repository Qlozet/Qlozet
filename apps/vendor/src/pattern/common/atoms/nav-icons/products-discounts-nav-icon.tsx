...
export const ProductsDiscountsNavIcon = ({ width, height }: IIconProps) => {
    ...
    return (
        ...
        >
            ...
            <path d="M3.9 12.0001L10.28 5.62006C10.66 5.24006 11.3 5.24006 11.68 5.62006L18.06 12.0001C18.44 12.3801 18.44 13.0201 18.06 13.4001L11.68 19.7801C11.3 20.1601 10.66 20.1601 10.28 19.7801L3.9 13.4001C3.52 13.0201 3.52 12.3801 3.9 12.0001Z" fill="currentColor" opacity="0.4" />
