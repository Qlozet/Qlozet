  ...
  return (
    <div className="flex items-center gap-2 border-t border-border bg-white dark:bg-card px-4 py-3">
      <button
        ...
        className="flex size-9 shrink-0 items-center justify-center rounded-full text-grey3 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors cursor-pointer"
      >
      ...
      <input
        ...
        className="h-10 flex-1 rounded-full bg-[#F1F1F1] dark:bg-[#4A4949] px-4 text-sm text-grey-black dark:text-white placeholder:text-grey2 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-ring"
      />
