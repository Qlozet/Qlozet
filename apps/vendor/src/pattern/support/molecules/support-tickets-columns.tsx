...
// Columns for the vendor Support → Tickets table. Matches the admin Support
// design (Ticket ID · Subject · User/Vendor Name · Category · Assigned To ·
// Status · Created At · chevron); field reads are tolerant of the loose Ticket
// shape (see ticket-fields).
export const createSupportTicketsColumns = (): ColumnDef<Ticket>[] => [
  {
    id: 'ticket_id',
    header: 'Ticket ID',
    cell: ({ row }) => (
      <span className='whitespace-nowrap text-sm font-medium text-[hsla(210,9%,31%,1)]'>
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return assigned ? (
        ...
        <span className='whitespace-nowrap text-sm text-[#E42C66]'>
          Unassigned
        </span>
      );
    },
  ...
  },
  {
    id: 'chevron',
    header: '',
    cell: () => <ChevronRight className='size-4 text-gray-400' />,
    enableSorting: false,
  },
];
