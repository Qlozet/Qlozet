...
// RTK Query service for the Qlozet "Transactions" tag.
...
export const transactionsApiSlice = baseAPI.injectEndpoints({
  endpoints: (builder) => ({
    // GET /transactions/vendor — paginated transactions for the vendor's business
    ...
    // GET /transactions/customer — paginated transactions for a customer
