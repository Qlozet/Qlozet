...
export const generateMockProduct = (overrides?: Partial<Product>): Product => {
  ...
  const statuses: Array<'active' | 'inactive' | 'draft'> = [
    'active',
    'inactive',
    'draft',
  ];
  ...
  return {
    ...
    customizations: hasCustomization
      ? Array.from({ length: faker.number.int({ min: 1, max: 2 }) }, () => ({
          ...
          options: faker.helpers.arrayElements(['Yes', 'No'], {
            min: 2,
            max: 2,
          }),
...
export const mockClothingProducts: Product[] = [
  ...
  },
  {
    ...
    variants: [{ id: '3-1', additionalPrice: 0, stock: 10, size: 'L' }],
    tags: ['women'],
  ...
  },
  {
    ...
    variants: [{ id: '4-1', additionalPrice: 0, stock: 0 }],
    tags: ['women'],
  ...
  },
  {
    ...
    variants: [{ id: '5-1', additionalPrice: 0, stock: 10, size: 'XL' }],
    tags: ['women'],
  ...
  },
  {
    ...
    variants: [{ id: '6-1', additionalPrice: 0, stock: 10, size: 'M' }],
    tags: ['women'],
...
export const getMockProductsPaginated = (
  ...
  const allProducts =
    totalCount <= mockClothingProducts?.length
      ? mockClothingProducts.slice(0, totalCount)
      : [
          ...mockClothingProducts,
          ...generateMockProducts(totalCount - mockClothingProducts?.length),
        ];
