...
const AddQuantity = ({ quantityHandler, quantity, listIndex, borderColor }) => {
  ...
  return (
    <div
      className={`flex items-center py-1 px-4 rounded-md  justify-between border-[1.5px]  border-solid ${borderColor ? 'border-primary' : 'border-gray-300'} w-full max-w-[150px]`}
    >
      <button
      ...
      <div>
        <input
          value={qty}
          className='text-primary font-medium text-base  flex items-center justify-center w-full '
          onChange={(e) => {
            const re = /^[0-9\b]+$/;
