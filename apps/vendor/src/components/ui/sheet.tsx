  ...
  'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
        ...
        right:
          'inset-y-0 right-0 h-full w-3/4 border-l sm:max-w-sm data-[state=open]:animate-[bounce-slide-in-right_500ms_cubic-bezier(0.22,1,0.36,1)_forwards] data-[state=closed]:animate-[slide-out-right_300ms_ease-in_forwards]',
      },
    },
    defaultVariants: {
      side: 'right',
