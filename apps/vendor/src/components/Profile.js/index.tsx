...
const Profile = ({
  ...
  return (
    <Sheet open={showProfile} onOpenChange={(open) => !open && showProfileHandler()}>
      <SheetContent
        side="right"
        className="w-full overflow-y-auto p-0 sm:max-w-md !top-6 !bottom-6 !right-6 !h-[calc(100vh-3rem)] rounded-[15px] custom-card-shadow !bg-white sidebar-scrollbar border border-gray-100"
      >
        <div className="bg-white rounded-[15px] pb-8 min-h-full w-full h-full text-[#1C1C1E]">
