...
const ENABLED_ROUTES: string[] = [APP_ROUTES.dashboard, APP_ROUTES.vendors, APP_ROUTES.customers, APP_ROUTES.admin, APP_ROUTES.orders, APP_ROUTES.productsCloth, APP_ROUTES.productsFabrics, APP_ROUTES.productsAccessories, APP_ROUTES.productsAdd, APP_ROUTES.notifications, APP_ROUTES.support]
