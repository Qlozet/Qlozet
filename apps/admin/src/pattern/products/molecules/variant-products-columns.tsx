...
interface VariantProductsColumnsProps {
  onAction?: (action: ProductAction, product: Product) => void;
}

// Columns shared by every "product with variants" catalogue (Clothing,
// Accessories): Picture · Product name · Product price · Category · Product type
// · Tag · Quantity (stock in variants) · Product Status · actions.
export const createVariantProductsColumns = ({
  onAction,
}: VariantProductsColumnsProps = {}): ColumnDef<Product>[] => [
  {
    id: 'picture',
    header: 'Picture',
    cell: ({ row }) => {
