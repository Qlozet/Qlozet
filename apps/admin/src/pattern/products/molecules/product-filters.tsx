...
import { AnchoredPopover } from '@/pattern/common/molecules/anchored-popover';
import type {
...
// `appearance-none` plus our own chevron: the native arrow is drawn by the
// browser hard against the right edge, ignoring the element's padding, so it
// sat flush to the border while the text had a comfortable inset.
const selectClass =
  'h-10 w-full appearance-none rounded-lg border border-border bg-transparent pl-3 pr-9 text-sm text-foreground outline-none focus:border-primary';
