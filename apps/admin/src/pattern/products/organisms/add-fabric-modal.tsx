...
export const AddFabricModal = NiceModal.create(() => {
  ...
  // Image: a local object URL drives the preview; a hosted URL (added via "Add
  // from URL") is what we submit, since there's no admin image-upload endpoint.
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex h-10 items-center rounded-md border border-input bg-background px-3">
              ...
              <input
                ...
                step="0.01"
                placeholder="0.00"
                // Show an empty field at 0 so the user starts from blank — binding
                // straight to the number kept a leading "0" that couldn't be cleared.
