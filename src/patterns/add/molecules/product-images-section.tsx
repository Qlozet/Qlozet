    ...
    <Card className="mb-6">
      ...
      <CardContent className="space-y-4">
        ...
        {selectedFiles.length > 0 && (
          <div>
            <Typography className="font-medium mb-2">Selected Files ({selectedFiles.length})</Typography>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {selectedFiles.map((file, index) => (
                <div key={index} className="relative group">
                  ...
                  <Typography variant="caption" className="text-xs text-gray-600 mt-1 truncate">
                    {file.name}
                  </Typography>
                </div>
              ))}
        ...
        {images.length > 0 && (
          <div>
            <Typography className="font-medium mb-2">Uploaded Images ({images.length})</Typography>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <div className="mt-4">
          <label className="text-sm font-medium mb-2 block">Alternative Upload</label>
          <Input
            type="file"
            accept="image/*"
            multiple
