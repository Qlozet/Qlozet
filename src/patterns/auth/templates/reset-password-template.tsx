...
import { ResetPasswordForm, ResetPasswordFormData } from '../molecules/reset-password-form';
...
export const ResetPasswordTemplate: React.FC<ResetPasswordTemplateProps> = ({
  ...
  const handleResetPassword = async (data: ResetPasswordFormData) => {
    if (!token) {
      toast(<Toast text="Invalid reset token. Please request a new password reset." type="danger" />);
      return;
    }
    ...
    try {
      ...
      toast(<Toast text={response.message || "Password reset successfully!"} type="success" />);
