...
import { useGetProductQuery, useUpdateProductMutation, useDeleteProductMutation } from '@/redux/services/products/products.api-slice';
          ...
          {isLoading ? (
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <TabsContent value="analytics" className="space-y-4">
                <div className="bg-white rounded-lg border p-6">
                  ...
                  <div className="mt-6 text-center text-gray-500">
                    <p>Analytics data will be available once the product starts receiving traffic</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="history" className="space-y-4">
                <div className="bg-white rounded-lg border p-6">
                  <h3 className="text-lg font-semibold mb-4">Product History</h3>
