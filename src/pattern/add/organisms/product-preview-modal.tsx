...
export const ProductPreviewModal = create<ProductPreviewModalProps>(
  ({ productData, categories, selectedFiles }) => {
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                ...
                <div className='space-y-2 text-sm'>
                  <div>
                    <strong>Name:</strong> {productData.name || 'Not specified'}
                  </div>
                  <div>
                  ...
                  <div>
                    <strong>Price:</strong> ${productData.price || 0}
                  </div>
                  <div>
                    <strong>Stock:</strong> {productData.stock || 0} units
                  </div>
                  <div>
              ...
              <div>
                {((productData.images?.length || 0) > 0 ||
                  ...
                  <div>
                    <Typography variant='h3' className='font-semibold mb-3'>
                      Images (
                      {(productData.images?.length || 0) + selectedFiles.length}
                      )
                    </Typography>
                    <div className='grid grid-cols-2 gap-2'>
                      ...
                      {/* Selected files */}
                      {selectedFiles
                        .slice(0, 4 - (productData.images?.length || 0))
                        .map((file, index) => (
                          <img
                            key={`file-${index}`}
                  ...
                  <div className='space-y-3 text-sm'>
                    ...
                    {productData.customizations.length > 3 && (
                      <div className='text-gray-500 text-center'>
                        +{productData.customizations.length - 3} more
                        customizations
                      </div>
                    )}
                  </div>
