      ...
      <div className='my-3'>
        ...
        <div
          ...
          focus:outline-none focus:bg-[#DDE2E5] focus:border-primary-100 ${
            error && 'border-danger'
          } border-gray-2 rounded-[8px] overflow-x-hidden text-sm text-font-light placeholder:font-300 ${
            disabled && 'border-0 bg-gray-300 cursor-not-allowed '
          } `}
        >
          <div className='scrollbar-hide overflow-x-scroll flex items-center gap-4 w-[97%]'>
            {showColorPicker && (
              <div className=''>
                <div
