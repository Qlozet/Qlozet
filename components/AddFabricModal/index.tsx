...
const AddFabricModal: React.FC<AddFabricModalProps> = ({ closeModal, submitAcessories }) => {
  ...
  const [accessoriesRequired, setAcesssoriesRequired] = useState<AccessoryRequired>({
    name: false,
    type: false,
    price: false,
    image: false,
