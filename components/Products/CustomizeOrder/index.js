import firstIcon from "../../../public/assets/svg/product-icon-2.svg";
...
const CustomizeOrder = ({ topNavData, closeModal }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full my-4">
      <CustomizeNav active="Tops" data={topNavData} closeModal={closeModal} />

      <div className="w-full md:w-[50%] bg-white px-5 rounded-b-[14px]">
        <Typography
          textColor="text-dark"
          textWeight="font-[600]"
          textSize="text-[14px]"
        ...
        <div>
          <div className="grid grid-cols-3 md:grid-cols-8 gap-4 py-4 mt-1">
